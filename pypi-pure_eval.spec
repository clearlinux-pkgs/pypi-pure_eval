...
Source0  : https://files.pythonhosted.org/packages/0d/44/5cedbf05cce044385eec8f88777325259610963abbeb3c1e80f93741d17a/pure_eval-0.2.1.tar.gz
...
%prep
%setup -q -n pure_eval-0.2.1
cd %{_builddir}/pure_eval-0.2.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1642440684
